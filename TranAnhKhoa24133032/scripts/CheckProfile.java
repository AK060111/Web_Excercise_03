...
public class CheckProfile {
    ...
    static User fixture(String suffix){
        ...
        User u=new User(name+"@example.invalid",name,"Test "+suffix,UUID.randomUUID().toString(),"avatar/existing.png",5,
            "09"+Long.toUnsignedString(new java.security.SecureRandom().nextLong()),java.sql.Date.valueOf(java.time.LocalDate.now()));
    ...
    public static void main(String[] args)throws Exception {
        ...
        try {
            ...
            String newPhone="08"+Long.toUnsignedString(new java.security.SecureRandom().nextLong());
